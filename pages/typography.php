...
<php lang="en">
    <head>
        ...
        <!--[if lt IE 9]>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/php5shiv/3.7.3/php5shiv.min.js"></script>
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <p>
                                        <abbr title="HyperText Markup Language" class="initialism">php</abbr>is an abbreviation for a programming language.</p>
                                    <br>
                                    <h4>Addresses</h4>
                                    <address>
